...
test('should place a move in the correct spot', function() {
...
test('should remove a surrounded piece', function() {
...
test('should remove a corner piece', function() {
    const board = new Board(3);
...
test('should be able to remove a whole lot of pieces', function() {
